		...
		<view style="width: 100%; border-bottom: 0 none; position: fixed; z-index: 2">
			<view style="background: #ffffff; position: relative">
				<view class="h-tab vp-flex">
					<view :class="'h-tab-item vp-flex_1 ' + (filt == '' ? 'on' : '')" @tap="onFilterChange('')">全部 </view>
					<view :class="'h-tab-item vp-flex_1 ' + (filt == 1 ? 'on' : '')" @tap="onFilterChange(1)">待支付</view>
					<view :class="'h-tab-item vp-flex_1 ' + (filt == 2 ? 'on' : '')" @tap="onFilterChange(2)">待接单</view>
					<view :class="'h-tab-item vp-flex_1 ' + (filt == 3 ? 'on' : '')" @tap="onFilterChange(3)">待服务</view>
					<view :class="'h-tab-item vp-flex_1 ' + (filt == 4 ? 'on' : '')" @tap="onFilterChange(4)">已完成</view>
					<view :class="'h-tab-item vp-flex_1 ' + (filt == 5 ? 'on' : '')" @tap="onFilterChange(5)">已取消</view>
				</view>
			</view>
		</view>

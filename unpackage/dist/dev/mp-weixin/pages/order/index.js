  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        k: common_vendor.n("h-tab-item vp-flex_1 " + (filt.value == 5 ? "on" : "")),
        l: common_vendor.o(($event) => onFilterChange(5)),
        m: list.value != null
      }, list.value != null ? common_vendor.e({
        n: list.value != null && list.value.length == 0
        ...
        v: common_vendor.t(countdown.value.validText),
        w: common_vendor.o(countdownChange),
        x: common_vendor.o(cancal),
        y: common_vendor.o(ok),
        z: common_vendor.sr(popup, "5e5a7a5a-4", {
          "k": "popup"
        }),
        A: common_vendor.p({
          type: "center",
